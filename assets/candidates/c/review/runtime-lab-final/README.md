# Evidência histórica do Combat Lab — c

[Relatório](capture-report.json) e amostras selecionadas da captura GPU de poses. As imagens completas ficam localmente em `target/art/c-combat-lab-compact-final`. O manifesto visual carregado foi comparado ao candidato daquela execução. A inspeção e as limitações estão no [laudo](../../../../production/c/review.md).
