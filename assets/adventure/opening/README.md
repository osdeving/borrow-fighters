...
A apresentação usa retratos e ilustrações locais. O [manifesto](roster.json)
carrega Rust, Duke, Old C, Python e C++; as origens e os hashes das cópias estão
no próprio JSON. A [procedência da arte](ART-PROVENANCE.md) preserva os prompts
e o histórico da produção inicial.

Em 10 de setembro de 2026, Go saiu da apresentação por solicitação do usuário.
Seu [atlas anterior](roster/go.png) permanece como histórico, fora do manifesto
