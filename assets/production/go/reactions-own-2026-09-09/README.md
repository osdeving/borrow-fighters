# Go — reações por contato

32 desenhos novos em oito clips, produzidos por `image_gen.imagegen` em 2026-09-09.
Gopher adulto atlético, olhos animais pequenos, focinho modelado, pelagem azul-ardósia, calça carvão, wraps escuros e patas nuas. A identidade caricatural antiga não foi usada.

Referência de continuidade: [arte existente](../reference/master.png).
...
- [Atlas runtime](../../../candidates/go/go-contact-reactions-atlas.png).
