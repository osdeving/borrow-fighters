# Duke / Java — reações por contato

32 desenhos novos em oito clips, produzidos por `image_gen.imagegen` em 2026-09-09.
Cone preto, nariz vermelho, corpo marfim, membros finos e vapor branco; nenhuma face humana foi acrescentada.
...
- [Atlas runtime](../../../candidates/duke/duke-contact-reactions-atlas.png).
