...
|---|---|---|---|---|
| Agora | Runtime de `frames[].combat` | Em andamento local | [`docs/11-sprite-pipeline.md`](11-sprite-pipeline.md), [`docs/12-technical-combat-guide.md`](12-technical-combat-guide.md), [`docs/adr/0007-sprite-frame-combat-runtime.md`](adr/0007-sprite-frame-combat-runtime.md) | Validar em jogo real com debug visual ligado e preencher metadata inicial dos personagens. |
| Proximo | Calibracao de sprite/hitbox | Planejado | [`docs/11-sprite-pipeline.md`](11-sprite-pipeline.md), [`docs/12-technical-combat-guide.md`](12-technical-combat-guide.md), [`docs/16-sprite-combat-viewer-roadmap.md`](16-sprite-combat-viewer-roadmap.md) | Usar o viewer para preencher `frames[].combat` primeiro no `special` do Rust e validar origem do projectile. |
