...
- janela: `1280 x 720`;
- escala de migracao: `RESOLUTION_SCALE = 4 / 3`;
- chao: `FLOOR_Y = 616`;
- arena jogavel: `ARENA_LEFT = 42,7`, `ARENA_RIGHT = 1237,3`;
- largura jogavel: `1194,7 px`;
- corpo fisico padrao em pe: `101,3 x 224 px`;
- corpo fisico padrao abaixado: `101,3 x 128 px`.

Isso da uma arena com cerca de `11,8` larguras de corpo (`1194,7 / 101,3`). Para o prototipo, o alvo e manter a largura jogavel entre `10` e `13` corpos padrao. Se caminhar de um canto ao outro parecer curto demais, a arena esta pequena; se o contato demorar demais para acontecer, a arena esta grande.
...
- altura visivel em idle: preferencialmente a mesma faixa principal, `247` a `280 px`, salvo decisao explicita de gameplay;
- largura visivel em idle: preferencialmente `147` a `200 px`;
