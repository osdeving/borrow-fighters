...
- primeiro corte de identidade mecânica: Rust mais técnico/responsivo, Duke mais longo/pesado e Go como rushdown com atlas placeholder no Combat Lab, no menu e em match via CLI, incluindo `ProjectileSpec` por personagem;
- colisão corpo-corpo;
